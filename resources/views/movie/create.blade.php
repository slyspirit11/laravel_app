<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 class="font-semibold text-left text-gray-800 leading-tight">
                <x-add-movie-link></x-add-movie-link>
                <x-user-name-link></x-user-name-link>
            </h2>
        </div>
    </x-slot>
    <div>
        <div class="mx-auto md:gap-6 w-2/3 my-5">
                    ...
                    <div class="shadow sm:rounded-md sm:overflow-hidden">
                        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                            <div class="grid grid-cols-3 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="director"
                                           class="block text-sm font-medium text-gray-700">Режиссёр</label>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="number" name="year" id="year" autocomplete="year" value="2000"
                                           class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                           required>
                                </div>
                            ...
                            <div>
                                ...
                                <textarea id="synopsys" name="synopsys" rows="3"
                                          ...
                                          w-full sm:text-sm border border-gray-300 rounded-md"></textarea>
                                </div>
                            </div>
